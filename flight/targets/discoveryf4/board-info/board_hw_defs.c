...
static const struct pios_spi_cfg pios_spi_gyro_cfg = {
	...
	.init = {
		...
		.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_8,	//84MHz / 8 == 10.5MHz
	},
	.use_crc = false,
	.dma = {
		.irq = {
