...
#ifndef PATHSEGMENT_DIALOG_H
#define PATHSEGMENT_DIALOG_H
...
/**
 * @brief The PathSegmentDialog class creates a dialog for editing the properties of a single waypoint
 */
class PATHPLANNER_EXPORT PathSegmentDialog : public QDialog
{
    Q_OBJECT

public:
    PathSegmentDialog(QWidget *parent, QAbstractItemModel *model, QItemSelectionModel * selection);
    ~PathSegmentDialog();
